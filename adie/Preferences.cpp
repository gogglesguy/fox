...
*********************************************************************************
* $Id: Preferences.cpp,v 1.74 2009/01/06 13:07:20 fox Exp $                     *
********************************************************************************/
#include "fx.h"
#include "icons.h"
#include "help.h"
...
Preferences::Preferences(TextWindow *own):FXDialogBox(own,"Adie Preferences",DECOR_TITLE|DECOR_BORDER|DECOR_RESIZE,0,0,0,0, 0,0,0,0, 4,4){
  ...
  new FXTextField(matrix2,6,own,TextWindow::ID_BRACEMATCH,JUSTIFY_RIGHT|FRAME_SUNKEN|FRAME_THICK|LAYOUT_CENTER_Y|LAYOUT_FILL_X|LAYOUT_FILL_ROW,0,0,0,0, 2,2,1,1);
