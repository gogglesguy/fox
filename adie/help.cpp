...
const char help[]=
  ...
  "ditional text may be subject to various interpretations.  When the selected stri"
  "ng is of the form:\n"
  "\n"
  "   #include \"filename.h\"\n"
  "\n"
  ...
  "   #include <filename.h>\n"
  "\n"
  "The editor will parse the filename from the string and open it in the same direc"
  "tory as the currently loaded file, and if not found there, look into a sequence "
  "of (possibly relative) search paths. [You can specify the list of search paths t"
  "o search by entering a list of absolute or relative pathnames into the 'Preferen"
  "ces' dialog, under the 'Miscellaneous' sub panel]. When the selected filename is"
  " of the form:\n"
  "\n"
  "   filename.cpp(177)\n"
  "\n"
