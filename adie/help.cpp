...
const char help[]=
  ...
  "\n"
  "To start a new document, invoke the New menu, or press on the New button on the "
  "toolbar.  If the current document has not yet been saved, you will be prompted t"
  "o either save or abandon the current text.\n"
  "\n"
  "\n"
  "Opening and Saving Files the Old Fashioned Way.\n"
  "\n"
  "To open a file, you can invoke the Open menu, or press on the Open button on the"
  " toolbar.  This will bring up the standard File Dialog, which allows you to sele"
  "ct a file.\n"
  "To save a file, you can either invoke the Save or the Save As menu option. The f"
  "ormer saves the file back to the same filename, while the latter prompts for an "
  "alternative filename.\n"
  "\n"
  "You can quickly navigate to the desired file by typing the first few letters of "
  "the filename and then pressing Enter (Return); use Backspace to move up one dire"
  "ctory level.  Control-H moves to your home directory, Control-W moves back to th"
  "e current working directory.\n"
  "\n"
  "A nice convenience of the File Dialog is the ability to set bookmarks, so once b"
  "ookmarked, you can quickly move back to a previously visited directory.\n"
  "\n"
  "\n"
  "Opening Files Using the File/Directory Browser.\n"
  "\n"
  "An alternative method to open files is the File/Directory Browser. You can displ"
  "ay the File/Directory Browser by invoking the File Browser option under the View"
  " menu.  To open a file using the File/Directory Browser, simply click on the fil"
  "e. If there are many files, you may want to limit the number of files displayed "
  "by specifying a file pattern in the Filter typein field.\n"
  "The pattern is can be any regular file wildcard expression such as \"*.cpp\".  B"
  "y default, the File/Directory Browser shows all files, i.e. the pattern is \"*\""
  ".\n"
  "You can switch patterns by means of the combo box under file File Browser; addit"
  "ional patterns for the combo box (and File Dialog) can be specified in the Prefe"
  "rences Dialog.\n"
  "\n"
  "\n"
  ...
  "ead this file.\n"
  "Of course, the File/Directory browser supports drag and drop also, so you can al"
  "so drag a file from the File/Directory browser into the Text Window.\n"
  "\n"
  "\n"
  "Opening a Selected Filename\n"
  "\n"
  "Selecting any filename, possibly in another application, and invoking the \"Open"
  " Selected\" option causes Adie to open the selected file. When the selected file"
  "name is of the form:\n"
  "\n"
  "   #include \"filname.h\"\n"
  "\n"
  ...
  "   #include <filename.h>\n"
  "\n"
  "then Adie will search for this file in a sequence of include search paths, other"
  "wise it will search in the same directory as the currently loaded file.  You can"
  " specify the list of search paths to search by entering a list of absolute or re"
  "lative pathnames into the Preferences dialog (Search Paths) text field.\n"
  ...
  "   filename.cpp:177:9   \n"
  "\n"
  "then Adie will not only load the filename, but also jump to the given line numbe"
  "r.  In case of the second form, it will also place the cursor on the 9-column.  "
  "If this file has already been loaded, Adie will simply jump to the given line (a"
  "nd column-) number in the open file.  This option is very useful when fixing com"
  "piler errors.\n"
  "Note, various popular compiler output formats are supported to obtain the necess"
  "ary information.\n"
  "\n"
  "\n"
  "Mouse Selection.\n"
  ...
  "\n"
  "  defaultfilebinding = \"/usr/local/bin/textedit %s &;Document;document.xpm;mini"
  "/document.xpm\"\n"
  ...
  "\" and is associated with two icons, a big icon \"c_src.xpm\" and a small icon \""
  "mini/c_src.xpm\", which are to be found in the directories determined by 'iconpa"
  "th\", in this case, \"/usr/share/icons\" or \"/home/jeroen/icons\".\n"
  "\n"
