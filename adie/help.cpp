...
const char help[]=
  ...
  "   filename.cpp:177:9\n"
  "\n"
  "Adie will not only load the filename, but also jump to the given line number, an"
  "d, in the second case, column number.  In the case above, it will also place the"
  " cursor on the 9-column of line 177.  If this file has already been loaded, Adie"
  " will simply jump to the given line (and column-) number in the already open fil"
  "e, and bring the file to the front.\n"
