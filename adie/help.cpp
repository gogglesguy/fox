...
const char help[]=
  ...
  "   #include <filename.h>\n"
  "\n"
  "then Adie will search for this file in a sequence of include directories, otherw"
  "ise it will search in the same directory as the currently loaded file.  You can "
  "specify the list of include directories to search with the \"Include Path\" opti"
  "on.\n"
  ...
  "r.  If this file has already been loaded, Adie will simply jump to the given lin"
  "e number in the current file.  This option is very useful when fixing compiler e"
  "rrors.\n"
  "\n"
  "\n"
  "Mouse Selection.\n"
