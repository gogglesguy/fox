# Set project-wide compiler flags for FOX
# These flags apply to the FOX library and bundled applications during their build.
# External consumers using find_package(FOX) do not inherit these flags.
...
check_cxx_compiler_flag(-Wno-implicit-fallthrough HAS_CXX_IMPLICIT_FALLTHROUGH)

# Check for other compilation flags
...
# Apply Release-specific optimization flags
if(HAS_CXX_FASTMATH)
...
# Apply warning flags (all configurations)
if(HAS_CXX_WALL)
...
# Native architecture optimization (if requested)
if(WITH_NATIVE)
