...
# ADD LINK32 winspool.lib comctl32.lib wsock32.lib ws2_32.lib kernel32.lib user32.lib gdi32.lib advapi32.lib shell32.lib mpr.lib imm32.lib /nologo /entry:"mainCRTStartup" /subsystem:windows /pdb:none /machine:I386
...
BuildCmds= \
	cd ..\..\..\adie \
	$(WkspDir)\reswrap\Release\reswrap -i icons.h  -o icons.cpp adie_gif.gif big_gif.gif bookdel_gif.gif booknext_gif.gif bookprev_gif.gif bookset_gif.gif browser.gif close_gif.gif colors_gif.gif config_gif.gif copy_gif.gif cut_gif.gif delete_gif.gif fonts_gif.gif help_gif.gif indent_gif.gif info_gif.gif lang_gif.gif lowercase.gif new_gif.gif nobrowser.gif open_gif.gif palette_gif.gif paste_gif.gif pattern_gif.gif print_gif.gif quit_gif.gif redo_gif.gif reload_gif.gif save_gif.gif saveas_gif.gif saveall_gif.gif search_gif.gif searchnext_gif.gif searchprev_gif.gif shiftleft_gif.gif shiftright_gif.gif small_gif.gif styles_gif.gif syntax_gif.gif undo_gif.gif uppercase.gif \
