...
/*  
  ...
  ScriptCommon                = 1,    /// Zyyy     
  ScriptInherited             = 2,    /// Zinh (was Qaai)
  ScriptArabic                = 3,    /// Arab     
  ScriptImperialAramaic       = 4,    /// Armi     
  ScriptArmenian              = 5,    /// Armn     
  ScriptAvestan               = 6,    /// Avst     
  ScriptBalinese              = 7,    /// Bali     
  ScriptBamum                 = 8,    /// Bamu     
  ScriptBengali               = 9,    /// Beng     
  ScriptBopomofo              = 10,   /// Bopo     
  ScriptBraille               = 11,   /// Brai     
  ScriptBuginese              = 12,   /// Bugi     
  ScriptBuhid                 = 13,   /// Buhd     
  ScriptCanadianAboriginal    = 14,   /// Cans     
  ScriptCarian                = 15,   /// Cari     
  ScriptCham                  = 16,   /// Cham     
  ScriptCherokee              = 17,   /// Cher     
  ScriptCoptic                = 18,   /// Copt (was Qaac)
  ScriptCypriot               = 19,   /// Cprt     
  ScriptCyrillic              = 20,   /// Cyrl     
  ScriptDevanagari            = 21,   /// Deva     
  ScriptDeseret               = 22,   /// Dsrt     
  ScriptEgyptianHieroglyphs   = 23,   /// Egyp     
  ScriptEthiopic              = 24,   /// Ethi     
  ScriptGeorgian              = 25,   /// Geor     
  ScriptGlagolitic            = 26,   /// Glag     
  ScriptGothic                = 27,   /// Goth     
  ScriptGreek                 = 28,   /// Grek     
  ScriptGujarati              = 29,   /// Gujr     
  ScriptGurmukhi              = 30,   /// Guru     
  ScriptHangul                = 31,   /// Hang     
  ScriptHan                   = 32,   /// Hani     
  ScriptHanunoo               = 33,   /// Hano     
  ScriptHebrew                = 34,   /// Hebr     
  ScriptHiragana              = 35,   /// Hira     
  ScriptKatakanaHiragana      = 36,   /// Hrkt     
  ScriptOldItalic             = 37,   /// Ital     
  ScriptJavanese              = 38,   /// Java     
  ScriptKayah_Li              = 39,   /// Kali     
  ScriptKatakana              = 40,   /// Kana     
  ScriptKharoshthi            = 41,   /// Khar     
  ScriptKhmer                 = 42,   /// Khmr     
  ScriptKannada               = 43,   /// Knda     
  ScriptKaithi                = 44,   /// Kthi     
  ScriptTaiTham               = 45,   /// Lana     
  ScriptLao                   = 46,   /// Laoo     
  ScriptLatin                 = 47,   /// Latn     
  ScriptLepcha                = 48,   /// Lepc     
  ScriptLimbu                 = 49,   /// Limb     
  ScriptLinearB               = 50,   /// Linb     
  ScriptLisu                  = 51,   /// Lisu     
  ScriptLycian                = 52,   /// Lyci     
  ScriptLydian                = 53,   /// Lydi     
  ScriptMalayalam             = 54,   /// Mlym     
  ScriptMongolian             = 55,   /// Mong     
  ScriptMeeteiMayek           = 56,   /// Mtei     
  ScriptMyanmar               = 57,   /// Mymr     
  ScriptNko                   = 58,   /// Nkoo     
  ScriptOgham                 = 59,   /// Ogam     
  ScriptOlChiki               = 60,   /// Olck     
  ScriptOldTurkic             = 61,   /// Orkh     
  ScriptOriya                 = 62,   /// Orya     
  ScriptOsmanya               = 63,   /// Osma     
  ScriptPhagsPa               = 64,   /// Phag     
  ScriptInscriptionalPahlavi  = 65,   /// Phli     
  ScriptPhoenician            = 66,   /// Phnx     
  ScriptInscriptionalParthian = 67,   /// Prti     
  ScriptRejang                = 68,   /// Rjng     
  ScriptRunic                 = 69,   /// Runr     
  ScriptSamaritan             = 70,   /// Samr     
  ScriptOldSouthArabian       = 71,   /// Sarb     
  ScriptSaurashtra            = 72,   /// Saur     
  ScriptShavian               = 73,   /// Shaw     
  ScriptSinhala               = 74,   /// Sinh     
  ScriptSundanese             = 75,   /// Sund     
  ScriptSylotiNagri           = 76,   /// Sylo     
  ScriptSyriac                = 77,   /// Syrc     
  ScriptTagbanwa              = 78,   /// Tagb     
  ScriptTai_Le                = 79,   /// Tale     
  ScriptNewTaiLue             = 80,   /// Talu     
  ScriptTamil                 = 81,   /// Taml     
  ScriptTaiViet               = 82,   /// Tavt     
  ScriptTelugu                = 83,   /// Telu     
  ScriptTifinagh              = 84,   /// Tfng     
  ScriptTagalog               = 85,   /// Tglg     
  ScriptThaana                = 86,   /// Thaa     
  ScriptThai                  = 87,   /// Thai     
  ScriptTibetan               = 88,   /// Tibt     
  ScriptUgaritic              = 89,   /// Ugar     
  ScriptVai                   = 90,   /// Vaii     
  ScriptOldPersian            = 91,   /// Xpeo     
  ScriptCuneiform             = 92,   /// Xsux     
  ScriptYi                    = 93    /// Yiii     
*/
