...
public:
  ...
  FXRealSlider(FXComposite* p,FXObject* tgt=nullptr,FXSelector sel=0,FXuint opts=REALSLIDER_NORMAL,FXint x=0,FXint y=0,FXint w=0,FXint h=0,FXint pl=0,FXint pr=0,FXint pt=0,FXint pb=0);
