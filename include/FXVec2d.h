...
public:
  ...
  explicit FXVec2d(FXdouble d):x(d),y(d){}
  ...
  FXVec2d& set(FXdouble dd){x=dd;y=dd;return *this;}
...
static inline FXVec2d normalize(const FXVec2d& v){ return v*Math::rsqrt(v.length2()); }

/// Normalize vector incrementally; assume |v| is approximately 1 already
static inline FXVec2d fastnormalize(const FXVec2d& v){ return v*((3.0-v.length2())*0.5); }

/// Clip vector to box -xlo...xhi and -ylo...yhi (xlo<0, ylo<0, 0<xhi, 0<yhi).
extern FXAPI FXVec2d clip(const FXVec2d& v,FXdouble xlo,FXdouble xhi,FXdouble ylo,FXdouble yhi);

/// Clip vector to box -xmx...xmx and -ymx...ymx (0<xmx, 0<ymx).
extern FXAPI FXVec2d clip(const FXVec2d& v,FXdouble xmx,FXdouble ymx);

/// Clip vector to box -mx...mx (0<mx).
extern FXAPI FXVec2d clip(const FXVec2d& v,FXdouble mx);
