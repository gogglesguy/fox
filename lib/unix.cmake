...
cmake_push_check_state()
  ...
  if(HAVE_PTHREAD_SETNAME_NP)
    target_compile_definitions(FOX PRIVATE HAVE_PTHREAD_SETNAME_NP)
  endif()
  check_cxx_symbol_exists(pthread_getname_np "pthread.h" HAVE_PTHREAD_GETNAME_NP)
  if(HAVE_PTHREAD_GETNAME_NP)
    target_compile_definitions(FOX PRIVATE HAVE_PTHREAD_GETNAME_NP)
  endif()
cmake_pop_check_state()
