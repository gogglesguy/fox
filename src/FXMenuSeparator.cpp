...
*********************************************************************************
* $Id: FXMenuSeparator.cpp,v 1.35 2008/01/04 15:42:25 fox Exp $                 *
********************************************************************************/
#include "xincs.h"
#include "fxver.h"
#include "fxdefs.h"
...
// Separator item
FXMenuSeparator::FXMenuSeparator(FXComposite* p,FXObject* tgt,FXSelector sel,FXuint opts):FXWindow(p,opts,0,0,0,0){
  flags|=FLAG_SHOWN;
