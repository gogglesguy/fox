...
*********************************************************************************
* $Id: FXColorNames.cpp,v 1.37 2009/01/06 13:24:27 fox Exp $                    *
********************************************************************************/
#include "xincs.h"
#include "fxver.h"
#include "fxdefs.h"
...
FXchar* fxnamefromcolor(FXchar* colorname,FXColor color){
  ...
  if(color && FXALPHAVAL(color)<255){
    __snprintf(colorname,MAXCOLORNAME,"#%02x%02x%02x%02x",FXREDVAL(color),FXGREENVAL(color),FXBLUEVAL(color),FXALPHAVAL(color));
    }
  else{
    ...
    __snprintf(colorname,MAXCOLORNAME,"#%02x%02x%02x",FXREDVAL(color),FXGREENVAL(color),FXBLUEVAL(color));
    }
  return colorname;
  }
